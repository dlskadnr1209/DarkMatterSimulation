...
c
	...
	n14=n1/4
	n21=n12+1
c	print*,'inside FFT3RKs -- before FFT13'
c        PRINT *, "Entering FFT3RKs"
c        PRINT *, "Initial fc shape: ", SHAPE(fc)
c        PRINT *, n1, n2, n3, n12,n14,n21
c        PRINT *, 'Before FFT: ', fc(32, 64, 64)
...
c        print*,fc(32,64,64)
c        PRINT *, "Exiting FFT3RKs"
c        PRINT *, "Final fc shape: ", SHAPE(fc)
c        PRINT *, "Final fc(1,1,1) =", fc(1,1,1)
...
c	print*,'before FFT33'
	call FFT33(fc,n21,n2,n3,isign)
c	print*,'after FFT33'
c  Now transform 2nd dimension.
c	print*,'before FFT23'
	call FFT23(fc,n21,n2,n3,isign)
c	print*,'after FFT23'
...
c  Now pack other planes.
	...
	do  k1=2,n14+1
	   ...
	   fc(k1c,:,:)=conjg(fe(:,:)-fo(:,:))
	enddo
c	print *,'end pack inverse'

c  FFT 1st dimension of a 3-D array.  Note that first dimension has
c  length n12+1 but transform length is only n12.
c	print *,'before FFT13'
	call FFT13(fc,n12,n2,n3,isign)
c	print *,'after FFT13'
